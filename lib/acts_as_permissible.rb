  ...
  module Acts #:nodoc:
    module Permissible #:nodoc:
      ...
      module InstanceMethods
        ...
        # accepts a permission identifier string or an array of permission
        # identifier strings
        # and return true if the user has all of the permissions given by the
        # parameters
        # false if not.
        ...
        # accepts a permission identifier string or an array of permission
        # identifier strings
        # and return true if the user has any of the permissions given by the
        # parameters
        # false if none.
        ...
        # permissible's permissions hash
